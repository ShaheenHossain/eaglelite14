
{
    ...
    'summary': """ Accounting Reports, PDC, Lock dates, 
                 Credit Limit, Follow Ups, 
                 Day-Bank-Cash book reports.""",
    'description': """
                    Accounting Reports, PDF Reports, Asset Management,
                    Customer Credit Limit, Recurring Payment,
                    PDC Management, Customer Follow-up,
                    Lock Dates into Odoo Accounting,Odoo 14 Accounting Reports,Odoo 14,, 
